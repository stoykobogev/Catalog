...
public class ProductController {
	...
	public int createProduct(@Valid @RequestBody ProductParams params) {
		return this.productService.createProduct(params);
	}
	
	@PutMapping("/{productId}")
	public void updateProduct(@Valid @RequestBody ProductParams params, @PathVariable int productId) {
